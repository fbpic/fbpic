...
def deposit_rho_gpu_cubic_one_mode(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            gpu_atomic_add(rho_m.real, (iz0, ir0), R_m_00.real)
            gpu_atomic_add(rho_m.real, (iz0, ir1), R_m_10.real)
            gpu_atomic_add(rho_m.real, (iz0, ir2), R_m_20.real)
            gpu_atomic_add(rho_m.real, (iz0, ir3), R_m_30.real)
            gpu_atomic_add(rho_m.real, (iz1, ir0), R_m_01.real)
            gpu_atomic_add(rho_m.real, (iz1, ir1), R_m_11.real)
            gpu_atomic_add(rho_m.real, (iz1, ir2), R_m_21.real)
            gpu_atomic_add(rho_m.real, (iz1, ir3), R_m_31.real)
            gpu_atomic_add(rho_m.real, (iz2, ir0), R_m_02.real)
            gpu_atomic_add(rho_m.real, (iz2, ir1), R_m_12.real)
            gpu_atomic_add(rho_m.real, (iz2, ir2), R_m_22.real)
            gpu_atomic_add(rho_m.real, (iz2, ir3), R_m_32.real)
            gpu_atomic_add(rho_m.real, (iz3, ir0), R_m_03.real)
            gpu_atomic_add(rho_m.real, (iz3, ir1), R_m_13.real)
            gpu_atomic_add(rho_m.real, (iz3, ir2), R_m_23.real)
            gpu_atomic_add(rho_m.real, (iz3, ir3), R_m_33.real)
            if m > 0:
                gpu_atomic_add(rho_m.imag, (iz0, ir0), R_m_00.imag)
                gpu_atomic_add(rho_m.imag, (iz0, ir1), R_m_10.imag)
                gpu_atomic_add(rho_m.imag, (iz0, ir2), R_m_20.imag)
                gpu_atomic_add(rho_m.imag, (iz0, ir3), R_m_30.imag)
                gpu_atomic_add(rho_m.imag, (iz1, ir0), R_m_01.imag)
                gpu_atomic_add(rho_m.imag, (iz1, ir1), R_m_11.imag)
                gpu_atomic_add(rho_m.imag, (iz1, ir2), R_m_21.imag)
                gpu_atomic_add(rho_m.imag, (iz1, ir3), R_m_31.imag)
                gpu_atomic_add(rho_m.imag, (iz2, ir0), R_m_02.imag)
                gpu_atomic_add(rho_m.imag, (iz2, ir1), R_m_12.imag)
                gpu_atomic_add(rho_m.imag, (iz2, ir2), R_m_22.imag)
                gpu_atomic_add(rho_m.imag, (iz2, ir3), R_m_32.imag)
                gpu_atomic_add(rho_m.imag, (iz3, ir0), R_m_03.imag)
                gpu_atomic_add(rho_m.imag, (iz3, ir1), R_m_13.imag)
                gpu_atomic_add(rho_m.imag, (iz3, ir2), R_m_23.imag)
                gpu_atomic_add(rho_m.imag, (iz3, ir3), R_m_33.imag)
...
def deposit_J_gpu_cubic_one_mode(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            ...
            gpu_atomic_add(j_r_m.real, (iz0, ir0), J_r_m_00.real)
            gpu_atomic_add(j_r_m.real, (iz0, ir1), J_r_m_10.real)
            gpu_atomic_add(j_r_m.real, (iz0, ir2), J_r_m_20.real)
            gpu_atomic_add(j_r_m.real, (iz0, ir3), J_r_m_30.real)
            gpu_atomic_add(j_r_m.real, (iz1, ir0), J_r_m_01.real)
            gpu_atomic_add(j_r_m.real, (iz1, ir1), J_r_m_11.real)
            gpu_atomic_add(j_r_m.real, (iz1, ir2), J_r_m_21.real)
            gpu_atomic_add(j_r_m.real, (iz1, ir3), J_r_m_31.real)
            gpu_atomic_add(j_r_m.real, (iz2, ir0), J_r_m_02.real)
            gpu_atomic_add(j_r_m.real, (iz2, ir1), J_r_m_12.real)
            gpu_atomic_add(j_r_m.real, (iz2, ir2), J_r_m_22.real)
            gpu_atomic_add(j_r_m.real, (iz2, ir3), J_r_m_32.real)
            gpu_atomic_add(j_r_m.real, (iz3, ir0), J_r_m_03.real)
            gpu_atomic_add(j_r_m.real, (iz3, ir1), J_r_m_13.real)
            gpu_atomic_add(j_r_m.real, (iz3, ir2), J_r_m_23.real)
            gpu_atomic_add(j_r_m.real, (iz3, ir3), J_r_m_33.real)
            if m > 0:
                gpu_atomic_add(j_r_m.imag, (iz0, ir0), J_r_m_00.imag)
                gpu_atomic_add(j_r_m.imag, (iz0, ir1), J_r_m_10.imag)
                gpu_atomic_add(j_r_m.imag, (iz0, ir2), J_r_m_20.imag)
                gpu_atomic_add(j_r_m.imag, (iz0, ir3), J_r_m_30.imag)
                gpu_atomic_add(j_r_m.imag, (iz1, ir0), J_r_m_01.imag)
                gpu_atomic_add(j_r_m.imag, (iz1, ir1), J_r_m_11.imag)
                gpu_atomic_add(j_r_m.imag, (iz1, ir2), J_r_m_21.imag)
                gpu_atomic_add(j_r_m.imag, (iz1, ir3), J_r_m_31.imag)
                gpu_atomic_add(j_r_m.imag, (iz2, ir0), J_r_m_02.imag)
                gpu_atomic_add(j_r_m.imag, (iz2, ir1), J_r_m_12.imag)
                gpu_atomic_add(j_r_m.imag, (iz2, ir2), J_r_m_22.imag)
                gpu_atomic_add(j_r_m.imag, (iz2, ir3), J_r_m_32.imag)
                gpu_atomic_add(j_r_m.imag, (iz3, ir0), J_r_m_03.imag)
                gpu_atomic_add(j_r_m.imag, (iz3, ir1), J_r_m_13.imag)
                gpu_atomic_add(j_r_m.imag, (iz3, ir2), J_r_m_23.imag)
                gpu_atomic_add(j_r_m.imag, (iz3, ir3), J_r_m_33.imag)
            # jt
            gpu_atomic_add(j_t_m.real, (iz0, ir0), J_t_m_00.real)
            gpu_atomic_add(j_t_m.real, (iz0, ir1), J_t_m_10.real)
            gpu_atomic_add(j_t_m.real, (iz0, ir2), J_t_m_20.real)
            gpu_atomic_add(j_t_m.real, (iz0, ir3), J_t_m_30.real)
            gpu_atomic_add(j_t_m.real, (iz1, ir0), J_t_m_01.real)
            gpu_atomic_add(j_t_m.real, (iz1, ir1), J_t_m_11.real)
            gpu_atomic_add(j_t_m.real, (iz1, ir2), J_t_m_21.real)
            gpu_atomic_add(j_t_m.real, (iz1, ir3), J_t_m_31.real)
            gpu_atomic_add(j_t_m.real, (iz2, ir0), J_t_m_02.real)
            gpu_atomic_add(j_t_m.real, (iz2, ir1), J_t_m_12.real)
            gpu_atomic_add(j_t_m.real, (iz2, ir2), J_t_m_22.real)
            gpu_atomic_add(j_t_m.real, (iz2, ir3), J_t_m_32.real)
            gpu_atomic_add(j_t_m.real, (iz3, ir0), J_t_m_03.real)
            gpu_atomic_add(j_t_m.real, (iz3, ir1), J_t_m_13.real)
            gpu_atomic_add(j_t_m.real, (iz3, ir2), J_t_m_23.real)
            gpu_atomic_add(j_t_m.real, (iz3, ir3), J_t_m_33.real)
            if m > 0:
                gpu_atomic_add(j_t_m.imag, (iz0, ir0), J_t_m_00.imag)
                gpu_atomic_add(j_t_m.imag, (iz0, ir1), J_t_m_10.imag)
                gpu_atomic_add(j_t_m.imag, (iz0, ir2), J_t_m_20.imag)
                gpu_atomic_add(j_t_m.imag, (iz0, ir3), J_t_m_30.imag)
                gpu_atomic_add(j_t_m.imag, (iz1, ir0), J_t_m_01.imag)
                gpu_atomic_add(j_t_m.imag, (iz1, ir1), J_t_m_11.imag)
                gpu_atomic_add(j_t_m.imag, (iz1, ir2), J_t_m_21.imag)
                gpu_atomic_add(j_t_m.imag, (iz1, ir3), J_t_m_31.imag)
                gpu_atomic_add(j_t_m.imag, (iz2, ir0), J_t_m_02.imag)
                gpu_atomic_add(j_t_m.imag, (iz2, ir1), J_t_m_12.imag)
                gpu_atomic_add(j_t_m.imag, (iz2, ir2), J_t_m_22.imag)
                gpu_atomic_add(j_t_m.imag, (iz2, ir3), J_t_m_32.imag)
                gpu_atomic_add(j_t_m.imag, (iz3, ir0), J_t_m_03.imag)
                gpu_atomic_add(j_t_m.imag, (iz3, ir1), J_t_m_13.imag)
                gpu_atomic_add(j_t_m.imag, (iz3, ir2), J_t_m_23.imag)
                gpu_atomic_add(j_t_m.imag, (iz3, ir3), J_t_m_33.imag)
            # jz
            gpu_atomic_add(j_z_m.real, (iz0, ir0), J_z_m_00.real)
            gpu_atomic_add(j_z_m.real, (iz0, ir1), J_z_m_10.real)
            gpu_atomic_add(j_z_m.real, (iz0, ir2), J_z_m_20.real)
            gpu_atomic_add(j_z_m.real, (iz0, ir3), J_z_m_30.real)
            gpu_atomic_add(j_z_m.real, (iz1, ir0), J_z_m_01.real)
            gpu_atomic_add(j_z_m.real, (iz1, ir1), J_z_m_11.real)
            gpu_atomic_add(j_z_m.real, (iz1, ir2), J_z_m_21.real)
            gpu_atomic_add(j_z_m.real, (iz1, ir3), J_z_m_31.real)
            gpu_atomic_add(j_z_m.real, (iz2, ir0), J_z_m_02.real)
            gpu_atomic_add(j_z_m.real, (iz2, ir1), J_z_m_12.real)
            gpu_atomic_add(j_z_m.real, (iz2, ir2), J_z_m_22.real)
            gpu_atomic_add(j_z_m.real, (iz2, ir3), J_z_m_32.real)
            gpu_atomic_add(j_z_m.real, (iz3, ir0), J_z_m_03.real)
            gpu_atomic_add(j_z_m.real, (iz3, ir1), J_z_m_13.real)
            gpu_atomic_add(j_z_m.real, (iz3, ir2), J_z_m_23.real)
            gpu_atomic_add(j_z_m.real, (iz3, ir3), J_z_m_33.real)
            if m > 0:
                gpu_atomic_add(j_z_m.imag, (iz0, ir0), J_z_m_00.imag)
                gpu_atomic_add(j_z_m.imag, (iz0, ir1), J_z_m_10.imag)
                gpu_atomic_add(j_z_m.imag, (iz0, ir2), J_z_m_20.imag)
                gpu_atomic_add(j_z_m.imag, (iz0, ir3), J_z_m_30.imag)
                gpu_atomic_add(j_z_m.imag, (iz1, ir0), J_z_m_01.imag)
                gpu_atomic_add(j_z_m.imag, (iz1, ir1), J_z_m_11.imag)
                gpu_atomic_add(j_z_m.imag, (iz1, ir2), J_z_m_21.imag)
                gpu_atomic_add(j_z_m.imag, (iz1, ir3), J_z_m_31.imag)
                gpu_atomic_add(j_z_m.imag, (iz2, ir0), J_z_m_02.imag)
                gpu_atomic_add(j_z_m.imag, (iz2, ir1), J_z_m_12.imag)
                gpu_atomic_add(j_z_m.imag, (iz2, ir2), J_z_m_22.imag)
                gpu_atomic_add(j_z_m.imag, (iz2, ir3), J_z_m_32.imag)
                gpu_atomic_add(j_z_m.imag, (iz3, ir0), J_z_m_03.imag)
                gpu_atomic_add(j_z_m.imag, (iz3, ir1), J_z_m_13.imag)
                gpu_atomic_add(j_z_m.imag, (iz3, ir2), J_z_m_23.imag)
                gpu_atomic_add(j_z_m.imag, (iz3, ir3), J_z_m_33.imag)
