...
\end{equation}
but on an irregular grid in $k_\perp$ (for the spectral grid). This is because the allowed
...
$B_z(r_{max}, z) = 0$). In this case, it turns out that the set of allowed
...
interesting discussions on the GPU implementation.
