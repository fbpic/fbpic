...
\comment{Fix notation : cylindrical, quasi-cylindrical, quasi-3D}
...
have enough time to develop in the case of lab-frame simulations.) 
Since the spectral quasi-cylindrical algorithm described here is
dispersion-free, it should not exhibit any numerical Cherenkov
radiation. In order to confirm this prediction, we ran a simulation of
...
$\Delta z = 0.05 \; \mathrm{\mu m}$ and $\Delta r = 0.5 \; \mathrm{\mu
...
\caption{\label{fig:Cherenkov} At a similar time. \comment{Add
    description}. \comment{Put absolute value of the fields and reduce
  number of numerical labels}}
\end{figure}
...
thank Axel Huebl for insightful discussions on the GPU implementation.
