...
\qquad \mathrm{with} \quad r_{q} \leq r < r_{q+1}
 \]
\noindent \comment{Note that we use linear shape factors here only for
...
high-frequency radiation. \comment{This radiation seems to be due to the
...
$\vec{k}$ space \citep{LehePRSTAB2013,XuCPC2013} on the lower left
...
\caption{\label{fig:Cherenkov}\comment{Snapshot of a finite-difference
