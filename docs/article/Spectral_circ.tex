...
% Articles Brendan on spectral boosted frame
...
instead of that of a full 3D Cartesian simulation. Moreover, unlike 2D Cartesian algorithms, these algorithms are well adapted to close-to-cylindrical
...
its capabilities, there are several other PIC algorithms that have
taken a similar -- yet not equivalent -- approach. One such example is the
...
is it dispersion-free. Another such example is the PIC code \textsc{PlaRes} 
...
In the present article, we start by deriving 
