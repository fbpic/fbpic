...
%is a common issue for cylindrical algorithms, and is discussed e.g. in
%\citep{Verboncoeur}).
...
line) and extracted from the simulation (red line). \comment{Check
  transverse grid}}
\end{figure}
...
that are closest to the axis, a region where cylindrical algorithms
