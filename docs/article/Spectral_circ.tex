...
longitudinal size of 40 $\mu$m and a transverse size of 48 $\mu$m. 
...
here, the group velocity is independent of the resolution, and
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\textwidth]{figures/Vacuum_vg.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\textwidth]{figures/Plasma_vg.pdf}
\caption{\label{fig:Plasma_vg}\comment{Finish this caption}.}
\end{figure}
