...
\comment{NOt the same parameters}
...
Since here $a_0 = 10^{-2}$, the wakefield is given by
linear, quasistatic theory \citep{EsareyRMP2009}:
\[ E_z(z, r, t) = \frac{mc^2}{e} \frac{k_p^2}{2}\int_{z}^{\infty} \langle
\vec{a}^2(z', r, t)\rangle \cos[k_p(z-z')]dz' \] 
\[ E_y(z, r, t) = -\frac{mc^2}{e} \frac{2 k_p y}{w_0^2}\int_{z}^{\infty} \langle
\vec{a}^2(z', r, t)\rangle \sin[k_p(z-z')]d\xi' \]
