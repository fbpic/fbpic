...
(and in particular the \emph{PSATD} algorithms)
...
We acknowledge computational resources from the JUROPA cluster, project HHH20, and the Physnet cluster, University of Hamburg.
