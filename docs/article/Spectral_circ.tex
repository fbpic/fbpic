...
\address[label1]{Lawrence Berkeley National Laboratory, Berkeley, California 94720, USA}
...
A nice abstract with a sum up 
\comment{Read over again}\comment{Add abstract}
